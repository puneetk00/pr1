 ...
 */
class TV_Faq_Adminhtml_Faq_CategoryController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    {
        $this->_initAction()
                ->_addContent($this->getLayout()->createBlock('tv_faq/adminhtml_category'))
                ->renderLayout();
    }
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
                ...
                ->_addContent(
                        $this->getLayout()
                                ->createBlock('tv_faq/adminhtml_category_edit')
                                ->setData('action', $this->getUrl('*/*/save'))
                )
                ->_addLeft($this->getLayout()->createBlock('tv_faq/adminhtml_category_edit_tabs'));
