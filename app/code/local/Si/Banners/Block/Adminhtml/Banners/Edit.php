...
class Si_Banners_Block_Adminhtml_Banners_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("banners_data") && Mage::registry("banners_data")->getId() ){
				    ...
				    return Mage::helper("banners")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("banners_data")->getId()));
