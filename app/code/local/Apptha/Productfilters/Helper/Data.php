...
class Apptha_Productfilters_Helper_Data extends Mage_Core_Helper_Data
{
  ...
  /*   public function getNewArrivalsDate()
    ...
    public function getLicenseText(){
    	...
    	//echo base64_encode('<a style="color:red;" href="http://www.apptha.com/checkout/cart/add/product/168" target="_blank"> - Buy now</a>');
    	return base64_decode('PGEgc3R5bGU9ImNvbG9yOnJlZDsiIGhyZWY9Imh0dHA6Ly93d3cuYXBwdGhhLmNvbS9jaGVja291dC9jYXJ0L2FkZC9wcm9kdWN0LzE2OCIgdGFyZ2V0PSJfYmxhbmsiPiAtIEJ1eSBub3c8L2E+');
    }
   ...
   public function extendedmassactionApiKey()
    {
