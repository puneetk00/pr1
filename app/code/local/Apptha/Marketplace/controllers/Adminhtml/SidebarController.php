...
class Apptha_Marketplace_Adminhtml_SidebarController extends Mage_Adminhtml_Controller_Action {
    ...
    protected function _initAction() {
         ...
         */
        $this->loadLayout ()->_setActiveMenu ( 'marketplace/items' )->_addBreadcrumb ( Mage::helper ( 'adminhtml' )->__ ( 'Sidebar Slider' ), Mage::helper ( 'adminhtml' )->__ ( 'Sidebar Slider' ) );
        return $this;
    }
    /**
    ...
    public function editAction() {
        ...
        if ($bannerModel->getId () || $id == 0) {
             ...
             */
            Mage::register ( 'marketplace_data', $bannerModel );
            /**
            ...
            if ($bannerModel->getId ()) {
                 ...
                 */
                $this->_title ( $this->__ ( 'New Sidebar Banner' ) );
            }
    ...
    public function saveAction() {
        ...
        if ($post = $this->getRequest ()->getPost ()) {
             ...
             * Save slider data
             */
            $bannerModel = Mage::getModel ( 'marketplace/sidebar' );
    ...
    public function massDeleteAction() {
        $bannersliderIds = $this->getRequest ()->getParam ( 'marketplace' );
        /**
    ...
    public function massStatusAction() {
        ...
        if (! is_array ( $bannersliderIds )) {
            ...
            try {
                 ...
                 */
                foreach ( $bannersliderIds as $bannersliderId ) {
                    Mage::getSingleton ( 'marketplace/sidebar' )->load ( $bannersliderId )->setStatus ( $this->getRequest ()->getParam ( 'status' ) )->save ();
                }
                /**
