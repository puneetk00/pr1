...
document.observe("dom:loaded", function() {
    ...
    try {
        ...
        for (i = 0; i < links.length; i++) {
			...
			if (links[i].href.search('/customer/account/register') != -1) {
                links[i].href = 'javascript:apptha_sociallogin(1,2);';
            }
			
			/* if (links[i].href.search('/cash-your-bundles') != -1) {
                links[i].href = 'javascript:apptha_sociallogin(1,2);';
            } */
			
			if (links[i].href.search('/shopwithbundlenaires') != -1) {
                links[i].href = document.getElementById("baseurl").value + "marketplace/seller/allseller";
            }
			
			if (links[i].href.search('/cash-your-bundles') != -1) {
                links[i].href = document.getElementById("baseurl").value + "who-can-be-a-seller";
            }
			
			if (links[i].href.match('/shop-for-bundles-8.html')) {
                links[i].href = "javascript:void(0)";
            }
			
			if (links[i].href.match('/straight.html')) {
                links[i].href = document.getElementById("baseurl").value + "/shop-for-bundles-8/bundles.html?filter=straight";
            }
			
			if (links[i].href.match('/wavy.html')) {
                links[i].href = document.getElementById("baseurl").value + "/shop-for-bundles-8/bundles.html?filter=wavy";
            }
			
			if (links[i].href.match('/curly.html')) {
                links[i].href = document.getElementById("baseurl").value + "/shop-for-bundles-8/bundles.html?filter=curly";
            }
			
			if (links[i].href.match('/coily.html')) {
                links[i].href = document.getElementById("baseurl").value + "/shop-for-bundles-8/bundles.html?filter=coily";
            }
